...
{
    public class PermissionNameAlreadyExistsException : EntityAlreadyExistsException
    {
        ...
        public PermissionNameAlreadyExistsException(string? message) : base(message)
        {
        }

        public PermissionNameAlreadyExistsException(string? message, Exception? innerException) : base(message, innerException)
        {
        }

        protected PermissionNameAlreadyExistsException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        protected override void SetClientMessage(StringBuilder builder) => builder.Append(
            Boundary is null
                ...
                : $"Permission with name '{Name}' in boundary '{Boundary.Name}' already exists"
        );
